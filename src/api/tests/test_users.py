# -*- coding: utf-8 -*-
"""
Created on Mon Jul  6 01:16:57 2020
...
class TestUsers(BaseTestCase):
    ...
    def test_create_user(self):
        user = {"username" : "kunalrelan2","password" : "helloworld","email" : "kunal.relan12@hotmail.com"}
    ...
    def test_create_user_without_username(self):
        user = {"password" : "helloworld","email" : "kunal.relan12@hotmail.com"}
        response = self.app.post('/api/users/',data=json.dumps(user),content_type='application/json)
        data = json.loads(response.data)
